...
router.get('/:id/stats/:season', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id, season } = req.params;
        const stats = yield prisma.playerGameStat.findMany({
            where: {
                playerId: id,
                game: {
...
router.get('/compare/:player1Id/:player2Id/:season', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { player1Id, player2Id, season } = req.params;
        // Get both players' info
        const [player1, player2] = yield Promise.all([
        ...
        const [player1Stats, player2Stats] = yield Promise.all([
...
router.get('/position/:position', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
